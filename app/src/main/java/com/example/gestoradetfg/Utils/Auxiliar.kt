...
object Auxiliar {
                ...
                for (doc_pedido in r_pedidos) {
                    ...
                    db.collection(COLECCION_PEDIDO).document(doc_pedido.id)
                        ...
                        .addOnSuccessListener { r_producto ->
                            ...
                            Log.w(ContentValues.TAG, "Coleccion: "+ COLECCION_PEDIDO_PRODUCTO+ " Error: ", exception)
                        }
                }
                miAdapterPedido.notifyDataSetChanged()
            }.addOnFailureListener { exception ->
    ...
    fun getProveedores() {
        ...
        // LLamada a la bd para recoger los usuarios
        db.collection(COLECCION_USUARIO)
            .get()
            .addOnSuccessListener { r_usuario ->

                // Bucle que recorre cada usuario
                for (doc_usuario in r_usuario) {


                    // Llamada a la bd que recoge todos los proveedores de el usuario
                    db.collection(COLECCION_USUARIO).document(doc_usuario.id)
                            ...
                            for (doc_proveedor in r_proveedor) {
                                ...
                                db.collection(COLECCION_USUARIO).document(doc_usuario.id)
                                    ...
                                    .addOnSuccessListener { r_productos ->
                                        ...
                                        Log.w(ContentValues.TAG, "Coleccion: "+ COLECCION_PRODUCTO+ " Error: ", exception)
                                    }
                            }
                        }.addOnFailureListener { exception ->
                            Log.w(ContentValues.TAG, "Coleccion: "+ COLECCION_PROVEEDOR+ " Error: ", exception)
                        }
                }
                miAdapterProveedor.notifyDataSetChanged()
            }.addOnFailureListener { exception ->
                Log.w(ContentValues.TAG, "Coleccion: "+ COLECCION_USUARIO+ " Error: ", exception)
            }
    }
    ...
    fun addPedido (pedido : Pedido, context: Context) {
        ...
        db.collection(COLECCION_PEDIDO).add(pedidoData).addOnSuccessListener {
            Toast.makeText(context, R.string.msgPedidoSucc, Toast.LENGTH_SHORT).show()

        }.addOnFailureListener {
                Toast.makeText(context, R.string.msgPedidoNoSucc, Toast.LENGTH_SHORT).show()
        }
    ...
    fun addProveedor (proveedor: Proveedor, context: Context) {
        ...
        db.collection(COLECCION_PROVEEDOR).add(proveedorData).addOnSuccessListener {
            Toast.makeText(context, R.string.msgProveedorSucc, Toast.LENGTH_SHORT).show()

        }.addOnFailureListener {
            Toast.makeText(context, R.string.msgProveedorNoSucc, Toast.LENGTH_SHORT).show()
        }
    ...
    fun addProducto (producto : Producto, context: Context) {
        ...
        db.collection(COLECCION_PEDIDO).add(productoData).addOnSuccessListener {
            Toast.makeText(context, R.string.msgProductoSucc, Toast.LENGTH_SHORT).show()

        }.addOnFailureListener {
            Toast.makeText(context, R.string.msgProductoNoSucc, Toast.LENGTH_SHORT).show()
        }
